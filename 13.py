...
# Ensure the lengths of titles, prices, and reviews are the same
if len(titles) != len(prices) != len(reviews) != len(stocks):
    raise ValueError("Lengths of titles, prices, and reviews lists do not match.")

# Combine titles, prices, and reviews into a list of lists
